...
PARAM_IP_UINT  (ripu, TID_IP_UINT,  PARAM_FLAG_PERSIST, 500);
PARAM_IP_FLOAT (ripf, TID_IP_FLOAT, PARAM_FLAG_PERSIST, 2.0f);
...
PARAM_MODULE_DEFINE(test_applet, TEST_MODULE_APPLET, "ResetApplet", NULL, mock_apply_ok);
IP_DRIVER_DEFINE(test_ip, TEST_MODULE_IP, "ResetIP", NULL, NULL, mock_ip_write_ok, NULL);
