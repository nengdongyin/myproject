...
PARAM_MODULE_DEFINE(test_applet, TEST_MODULE_APPLET, "BoundApplet", NULL, mock_apply_ok);
IP_DRIVER_DEFINE(test_ip, TEST_MODULE_IP, "BoundIP", NULL, NULL, mock_ip_write_ok, NULL);
...
void test_register_duplicate_param_across_modules(void) {
    ...
    PARAM_MODULE_DEFINE(test2, TEST_MODULE_APPLET2, "Applet2", NULL, NULL);
...
void test_ip_max_64_params(void) {
    ...
    IP_DRIVER_DEFINE(big_ip, TEST_MODULE_IP2, "BigIP", NULL, NULL, NULL, NULL);
