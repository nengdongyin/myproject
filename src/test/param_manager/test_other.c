...
PARAM_MODULE_DEFINE(test_applet, TEST_MODULE_APPLET, "OtherApplet", NULL, mock_apply_ok);
IP_DRIVER_DEFINE(test_ip, TEST_MODULE_IP, "OtherIP", NULL, NULL, mock_ip_write_ok, NULL);
...
void test_write_immediate_ip_no_write_cb(void) {
    test_ip_instance.write_cb = NULL;
    register_all();
...
PARAM_MODULE_DEFINE(test_str_mod, STR_TEST_MODULE, "StrMod", NULL, mock_apply_ok);
