 ...
 * @brief Ymodem 公共模块实现 —— CRC16 查表计算
 *
 * 实现 XMODEM CCITT CRC16 标准（多项式 0x1021, 初始值 0）。
 * 使用 256 项预计算查找表实现 O(n) 时间复杂度的逐字节 CRC 校验。
 */
